...
public class RedisDao {
	...
	public static void listops(Jedis redis){
        //**  LIST 操作   
	...
	//**  STRING 操作
	public static void stringops(Jedis redis){
		//**  STRING 操作   
	...
	// sort sets操作
	public static void sortops(Jedis redis){
	...
	//**  SET 操作  
	public static void setops(Jedis redis){
	...
	//**  KEY操作 
	public static void keyops(Jedis  redis){
		//KEYS   
